...
MenuItem {
    ...
    y:77
    visible: false;
    menuLayerId: "SBatteryVolTempInfo9"
    ...
    enterMenu: function(){}
    hideMenu: function(){
        UiController.hideLayer("SBatteryVolTempInfo9");
        UiController.showLayer("MenuPanel");
    }
    previousMenu: function(){
        UiController.hideLayer("SBatteryVolTempInfo9");
        UiController.showLayer("SBatteryVolTempInfo8");
    }
    nextMenu: function(){
        UiController.hideLayer("SBatteryVolTempInfo9");
        UiController.showLayer("SBatteryVolTempInfo10");
    }
