...
MenuItem {
    ...
    y:77
    visible: false;
    menuLayerId: "SBatteryVolTempInfo4"
    ...
    enterMenu: function(){}
    hideMenu: function(){
        UiController.hideLayer("SBatteryVolTempInfo4");
        UiController.showLayer("MenuPanel");
    }
    previousMenu: function(){
        UiController.hideLayer("SBatteryVolTempInfo4");
        UiController.showLayer("SBatteryVolTempInfo3");
    }
    nextMenu: function(){
        UiController.hideLayer("SBatteryVolTempInfo4");
        UiController.showLayer("SBatteryVolTempInfo5");
    }
