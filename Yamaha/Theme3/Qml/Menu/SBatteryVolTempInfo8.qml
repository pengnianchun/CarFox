...
MenuItem {
    ...
    y:77
    visible: false;
    menuLayerId: "SBatteryVolTempInfo8"
    ...
    enterMenu: function(){}
    hideMenu: function(){
        UiController.hideLayer("SBatteryVolTempInfo8");
        UiController.showLayer("MenuPanel");
    }
    previousMenu: function(){
        UiController.hideLayer("SBatteryVolTempInfo8");
        UiController.showLayer("SBatteryVolTempInfo7");
    }
    nextMenu: function(){
        UiController.hideLayer("SBatteryVolTempInfo8");
        UiController.showLayer("SBatteryVolTempInfo9");
    }
