...
Item {
    ...
    Image {     //左边仪表盘
        ...
        x:68     //68
        y:26  //26
        source: "qrc:/Theme/Theme1/Image/1st/dashboard/left/l_dashboard.png"

        Image {     //左边仪表盘上的mpa
            id: mpa_left
            source: "qrc:/Theme/Theme1/Image/1st/mpa/left/mpa_line_bg.png"
            x:103
            y:111
            width:185
            height:256
...
//                                running = false;
        ...
        Item{     //左边仪表盘指示点所在区域（用于旋转dot）
            ...
            Image {     //左边仪表盘指示点
                ...
                source: "qrc:/Theme/Theme1/Image/1st/dashboard/left/biaoge_light.png"
                x:-7
                y:208
                width:73
                height:66
        ...
        Item{     //左边仪表盘指示点clip显示区域
            ...
            Item{   //左边仪表盘线区域
                ...
                Image {
                    ...
                    source: "qrc:/Theme/Theme1/Image/1st/dashboard/left/1.png"
                    x:35
                    y:234
                    width:199
                    height:199
