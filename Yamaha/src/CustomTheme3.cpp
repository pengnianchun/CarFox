...
//       addLayer("qrc:/Theme/Theme3/Qml/TriggerPanel.qml", "Theme3TriggerPanel", carfox::Layer::ManualShow);
    ...
    addLayer("qrc:/Theme/Theme3/Qml/Menu/SBatteryVolTempInfo1.qml","SBatteryVolTempInfo1",carfox::Layer::ManualShow);
    addLayer("qrc:/Theme/Theme3/Qml/Menu/SBatteryVolTempInfo2.qml","SBatteryVolTempInfo2",carfox::Layer::ManualShow);
    addLayer("qrc:/Theme/Theme3/Qml/Menu/SBatteryVolTempInfo3.qml","SBatteryVolTempInfo3",carfox::Layer::ManualShow);
    addLayer("qrc:/Theme/Theme3/Qml/Menu/SBatteryVolTempInfo4.qml","SBatteryVolTempInfo4",carfox::Layer::ManualShow);
    addLayer("qrc:/Theme/Theme3/Qml/Menu/SBatteryVolTempInfo5.qml","SBatteryVolTempInfo5",carfox::Layer::ManualShow);
    addLayer("qrc:/Theme/Theme3/Qml/Menu/SBatteryVolTempInfo6.qml","SBatteryVolTempInfo6",carfox::Layer::ManualShow);
    addLayer("qrc:/Theme/Theme3/Qml/Menu/SBatteryVolTempInfo7.qml","SBatteryVolTempInfo7",carfox::Layer::ManualShow);
    addLayer("qrc:/Theme/Theme3/Qml/Menu/SBatteryVolTempInfo8.qml","SBatteryVolTempInfo8",carfox::Layer::ManualShow);
    addLayer("qrc:/Theme/Theme3/Qml/Menu/SBatteryVolTempInfo9.qml","SBatteryVolTempInfo9",carfox::Layer::ManualShow);
    addLayer("qrc:/Theme/Theme3/Qml/Menu/SBatteryVolTempInfo10.qml","SBatteryVolTempInfo10",carfox::Layer::ManualShow);
    ...
    addLayer("qrc:/Theme/Theme3/Qml/Menu/FrontModule.qml","FrontModule",carfox::Layer::ManualShow);
    addLayer("qrc:/Theme/Theme3/Qml/Menu/MiddleModule.qml","MiddleModule",carfox::Layer::ManualShow);
    addLayer("qrc:/Theme/Theme3/Qml/Menu/BackModule.qml","BackModule",carfox::Layer::ManualShow);
