...
TransformRing::TransformRing(QQuickItem *parent)
...
void TransformRing::setRo(qreal v)
{
    if (v == mRo)
        return;
...
void TransformRing::setRi(qreal v)
{
    if (v == mRi)
        return;
...
void TransformRing::setStartAngle(qreal v)
{
    if (v == mStartAngle)
        return;
...
void TransformRing::setEndAngle(qreal v)
{
    if (v == mEndAngle)
        return;
...
void TransformRing::setAngle(qreal v)
{
    if (v == mAngle)
        return;
...
void TransformRing::setDiv(int v)
{
    if (v == mDiv)
        return;
...
void TransformRing::setTex(const QUrl &v)
{
    if (v == mTex)
        return;
...
void TransformRing::setClockwise(bool v)
{
    if (v == mClockwise)
        return;
...
QSGNode *TransformRing::updatePaintNode(QSGNode *oldNode, UpdatePaintNodeData *)
{
...
QSGMaterial *TransformRing::createMaterial(const QUrl &url)
{
    QString path;
...
void TransformRing::setVertex(QSGGeometry::TexturedPoint2D *vertex, qreal a)
{
...
bool TransformRing::urlToPath(const QUrl &url, QString &path)
{
    if (url.scheme() == "file")
