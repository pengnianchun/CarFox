...
Item {
    ...
    Rectangle {
        ...
        Rectangle {
            id: line2
            x: 24
            y: line1.y + batteryManagementMenu.verticalSpace
            width:  displayBox.width
            height: 1
            color: "white"
            radius: 10
        ...
        Rectangle {
            id: line3
            x: 24
            y: line2.y + batteryManagementMenu.verticalSpace
            width:  displayBox.width
            height: 1
            color: "white"
            radius: 10
        ...
        Rectangle {
            id: line4
            x: 24
            y: line3.y + batteryManagementMenu.verticalSpace
            width:  displayBox.width
            height: 1
            color: "white"
            radius: 10
        ...
        Rectangle {
            id: line5
            x: 24
            y: line4.y + batteryManagementMenu.verticalSpace
            width:  displayBox.width
            height: 1
            color: "white"
            radius: 10
        ...
        Rectangle {
            id: line6
            x: 24
            y: line5.y + batteryManagementMenu.verticalSpace
            width:  displayBox.width
            height: 1
            color: "white"
            radius: 10
        ...
        Rectangle {
            id: line7
            x: 24
            y: line6.y + batteryManagementMenu.verticalSpace
            width:  displayBox.width
            height: 1
            color: "white"
            radius: 10
        ...
        Rectangle {
            id: line8
            x: 24
            y: line7.y + batteryManagementMenu.verticalSpace
            width:  displayBox.width
            height: 1
            color: "white"
            radius: 10
